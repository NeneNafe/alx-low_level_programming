 ...
 *
 * Description: if the file is not an ELF, or on error,
...
/**
 * print_magic - prints the magic numbers in an ELF head
 * @e_ident: A pointer to an array
 *
...
/**
 * print_osabi - prints the OS/ABI of an elf head file
 * @e_ident: A pointer to an array
 */
...
/**
 * print_abi - Prints the ABI version of the elf header file
 * @e_ident: A pointer to an array
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_type - prints the type of elf header file
 * @e_type: the elf type
 * @e_ident: A pointer to an array
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
 ...
 *
 * Description: if the file cannot be closes, then exit code 98
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * @argc: argument count
 *
 * Descripion: In this function if the file is not an elf
 * or th function fails - exit code 98.
